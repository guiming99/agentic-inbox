...
export default function EmailIframe({ body, mailboxId, emailId, attachments, autoSize }: EmailIframeProps) {
	...
	useEffect(() => {
		...
		const linkScript = `<script>document.querySelectorAll("a[href]").forEach(function(link){link.target="_blank";link.rel="noopener noreferrer";});<\/script>`;
